...
namespace FarmerApp.Repository
{
	public class TreatmentRepository : ITreatmentRepository
	{
        ...
        public List<Treatment> GetAll() => _dbContext.Treatments.AsNoTracking().ToList();
        ...
        public Treatment GetById(int id) => _dbContext.Treatments.AsNoTracking().SingleOrDefault(x => x.Id == id);
